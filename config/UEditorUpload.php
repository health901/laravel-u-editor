...
return [
    ...
    */
    ...
    'upload' => [
        ...
        "scrawlPathFormat" => "/ueditor/scrawl/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "snapscreenPathFormat" => "/ueditor/snapscreen/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
